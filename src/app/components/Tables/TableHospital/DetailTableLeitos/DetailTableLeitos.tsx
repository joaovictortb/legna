        ...
        <table className="min-w-full divide-y-2 divide-gray-200">
          <thead className="bg-white">
            <tr className="w-full">
              ...
              <th className="px-5 py-8 text-left text-base font-semibold text-[#272727]">
                Ações
              </th>
            </tr>
          </thead>
          <tbody className="bg-white divide-y-2 divide-gray-200">
            {currentRows.map((user, index) => (
              ...
              >
                ...
                <td className="px-5 py-8 whitespace-nowrap text-sm font-medium">
...
export default DetailTableLeitos;
